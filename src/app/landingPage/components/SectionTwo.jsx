              ...
              <div className="row">
                ...
                >
                  <div className="sx-about-bx1-content">
                    ...
                    <p>
                      {page === "web-development"
                        ? "Our web development solutions are meticulously crafted to meet your immediate needs while anticipating future challenges. We are committed to delivering innovative, tailor-made websites that drive real results. At MANYAA TECH SOLUTIONS, we understand that each organization is unique. That’s why we take the time to understand your specific goals and challenges, enabling us to create customized strategies that enhance your online presence and propel your business forward. Partner with us to build a digital experience that inspires confidence and growth."
                        : "Our app development solutions are designed to address your immediate needs and adapt to tomorrow’s challenges. At MANYAA TECH SOLUTIONS, we are dedicated to creating innovative, user-centric apps that deliver impactful results. We recognize that every organization has unique goals, which is why we tailor our approach to meet your specific needs. Let us partner with you to develop an app strategy that drives success, engages users, and positions your business for the future."}
                    </p>
                  </div>
                </div>
                <div
                  ...
                  data-wow-duration="1000ms"
                >
                  <div className="sx-about-bx1-media" style={{ width: "100%" }}>
                    <div className="sx-dot-bx">
                      <ItodoImage src="images/about/dotted-pic.png" alt="" />
                    </div>
                    <div className="sx-ab-img-outer" style={{ width: "100%" }}>
                      <div
                        className="sx-ab-img-section-2"
                        style={{ width: "100%" }}
                      >
                        <img
